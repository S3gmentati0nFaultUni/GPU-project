...
\\
Development and performance analysis of the original project have been carried out using the Google
Colab hosting service\footnote{\url{https://colab.research.google.com/}}. The extension has been
written and tested on my personal machine, which specs can be found in~\ref{tbl:system}, have been
gathered through the official documentation and thrid party
websites~\cite{rtx-2060-powerup, rtx-2060-evga, r7-3700x}.
\begin{center}
	\begin{longtable}{|c|c|c|}
		...
		\textbf{Manufacturer}               & AMD                        & EVGA                                                                \\\hline

		\textbf{Model}                      & Ryzen 7 3700X              & RTX 2060 KO                                                         \\\hline
		\textbf{Launch Date}                & Jul 2019                   & Jan 2020                                                            \\\hline
		\textbf{\#Cores}                    & $8$ cores 16 threads       & $\num{1920}$ C\footnote{CUDA cores}, $240$ T\footnote{Tensor cores} \\\hline
		\textbf{Clock Speed (GHz)}          & m: $3.6$ GHz, M: $4.4$ GHz & m: $1365$ MHz, M: $1680$ MHz                                        \\\hline
		\textbf{Memory / Cache}             & \makecell{L1: 64 KB                                                                              \\ L2: 512 KB \\ L3: 32 MB\footnote{All measurements are per-core}} & VRAM: $16$ GB GDDR6                                                 \\\hline
		\textbf{Memory Bandwidth}           & N.A.                       & 336 GB/s                                                            \\\hline
		\textbf{TDP (Thermal Design Power)} & $65$ W                     & $160$ W                                                             \\\hline
		\textbf{Architecture}               & Matisse ($7$ nm)           & Turing
	\end{longtable}
\end{center}
...
of the \texttt{exclusive\_scan} procedure implemented in the CUDA thrust library. Interestingly
